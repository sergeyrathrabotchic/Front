...
function clickImg2 ( Id, Id2, Id3, Id4 , Id5, idBlock) {
        setTimeout(brightness50, 110,  "#raion2");
        /*setTimeout(displayFlex, 130, "#raion2");*/
        setTimeout(brightnessMax, 500, "#raion2");
        /*setTimeout(brightness50, 100, "#block1");setTimeout(displayNone, 100, "#block1");
...
function clickImg () {
        setTimeout(brightness50, 110,  "#raion2");
        setTimeout(brightnessNull, 500,  "#raion2",'','','','');
        /*setTimeout(displayNone, 700,  "#raion2");*/
