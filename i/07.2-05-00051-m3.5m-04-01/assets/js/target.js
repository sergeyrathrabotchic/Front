...
transferPicture(history1);
transferPicture(history2);
transferPicture(history3);
/*transferPicture(history4);
transferPicture(history5);
transferPicture(history6);
transferPicture(history7);
transferPicture(history8);
transferPicture(history9);
transferPicture(history10);*/
