...
function transferPicture(img)
{
    ...
    img.onmousedown = function(event) { 
        ...
        || startingPosition != target13 || startingPosition != target14) {
            ...
            if (startingPosition){
                //alert(img.id == "Simbol");
                if (img.id == "text1" || img.id == "text3" || img.id == "text6" || img.id == "text8"){
                ...
                if (startingPosition){
                    if (img.id == "text2" || img.id == "text4" || img.id == "text5" || img.id == "text7"){
...
transferPicture(text5);
transferPicture(text6);
transferPicture(text7);
transferPicture(text8);
