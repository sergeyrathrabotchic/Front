...
transferPicture(chickenLegged);
transferPicture(magicStove);
transferPicture(flyingShip);
transferPicture(bootsOfSpeed);
transferPicture(levitatingMortar);
transferPicture(magicCarpet);
/*transferPicture(baggageClaim);
transferPicture(checkInDesk);
transferPicture(airline);
transferPicture(gate);
