...
transferPicture(arrivals);
transferPicture(departures);
transferPicture(securityControl);
transferPicture(informationBoard);
transferPicture(passportControl);
